    ...
    AlertDialog(
        ...
        text = {
            Column(
                ...
                Text(text = stringResource(Res.string.github_acess_token_tips_2))
                Spacer(modifier = Modifier.height(8.dp))
                Text(text = stringResource(Res.string.github_acess_token_tips_3))
                Spacer(modifier = Modifier.height(8.dp))
                Text(text = stringResource(Res.string.github_acess_token_tips_4))
                Spacer(modifier = Modifier.height(8.dp))
